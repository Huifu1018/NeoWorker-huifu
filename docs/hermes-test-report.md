...
更新时间：2026-09-11。当前开发分支：`codex/hermes-neoworker`；交付远端为 `Huifu1018/NeoWorker-huifu`。当前交付提交为 `922eaed`。本轮桥接、恢复、断点、Shell 稳定性、checkpoint 性能、分块输出缓冲和跨平台安装包校验改动已通过验证，并已推送。
